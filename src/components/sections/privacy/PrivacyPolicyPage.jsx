...
const CONTENT = {
  en: {
    ...
    sections: [
      ...
      ["Storage on your device", "Game sessions, recent match history, player-name preferences, language, theme, sound, music, and intro preferences may be stored in your browser's localStorage or sessionStorage. This keeps the game functional and lets you resume a game. You can remove this information by clearing site data in your browser."],
