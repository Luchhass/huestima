  ...
  return (
    <div className="home-view-panel flex h-full flex-col">
      <div className="home-view-copy max-w-[23rem] pr-10">
        <h1 className="text-[clamp(2.15rem,10.5vw,3.15rem)] font-semibold lowercase leading-[0.88] tracking-normal text-white sm:text-[4.05rem]">
          {t("setup.multiplayer")}
        </h1>

        <p className="mt-4 text-[0.92rem] font-medium leading-[1.22] text-white/82 sm:text-[0.98rem]">
          {description}
        </p>
      </div>
      ...
      <div className="home-view-actions mt-3 grid w-full grid-cols-[1.08fr_1fr] items-center gap-2 sm:grid-cols-2 sm:gap-3">
        <PlayerNameField
          value={playerName}
          onChange={(value) => {
            setPlayerName(value);
