  ...
  en: {
    ...
    setup: {
      ...
      singleCopy: {
        ...
        visualRush: "Visual rounds start directly; complete as many as possible during thirty seconds of active play.",
        visualElimination: "Visual rounds start directly and continue only while you clear the rising accuracy threshold.",
  ...
  tr: {
    ...
    setup: {
      ...
      singleCopy: {
        ...
        visualRush: "Görsel turlar doğrudan başlar; yalnızca aktif oyunda işleyen 30 saniyede olabildiğince çok seviye tamamla.",
        visualElimination: "Görsel turlar doğrudan başlar ve yalnızca yükselen doğruluk barajını geçtiğin sürece devam eder.",
