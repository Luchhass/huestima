...
export const DICTIONARIES = {
  en: {
    ...
    gameModeDescription: {
      ...
      timed: "Timed rounds give you three seconds to memorize and three seconds to choose.",
    ...
    setup: {
      ...
      cartoon: "Cartoon mode keeps the scene in place while you rebuild the main painted color across {roundCount} levels.",
      ...
      cartoon: "Everyone gets the same cartoon scene, and main color accuracy decides the room.",
  ...
  tr: {
    ...
    gameModeDescription: {
      ...
      timed: "Süreli turlar rengi ezberlemek için üç saniye, seçmek için üç saniye verir.",
      gradient: "İki renkli geçişin sol ve sağ tonunu eşleştir.",
      flag: "Sabit bayrak sembolünün arkasındaki rengi eşleştir.",
      cartoon: "Çizgi film sahnesindeki ana rengi eşleştir.",
    ...
    setup: {
      ...
      singleCopy: {
        ...
        cartoon: "Çizgi film modunda sahne sabit kalır; ana boyalı rengi {roundCount} seviye boyunca yeniden kurarsın.",
      ...
      multiCopy: {
        ...
        cartoon: "Herkes aynı çizgi film sahnesini görür; ana renk doğruluğu sonucu belirler.",
