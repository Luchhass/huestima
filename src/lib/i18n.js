...
export const DICTIONARIES = {
  en: {
    ...
    gameModeDescription: {
      ...
      timed: "Three seconds to memorize, two seconds to choose.",
    ...
    setup: {
      ...
      singleCopy: {
        ...
        timed: "Memorize each color for three seconds, then lock your guess in two seconds.",
      ...
      multiCopy: {
        ...
        timed: "Everyone gets three seconds to memorize and two seconds to choose.",
  ...
  tr: {
    ...
    gameModeDescription: {
      ...
      timed: "Rengi ezberlemek için üç saniye, seçmek için iki saniye.",
    ...
    setup: {
      ...
      singleCopy: {
        ...
        timed: "Her rengi üç saniye ezberle, sonra tahminini iki saniyede kilitle.",
      ...
      multiCopy: {
        ...
        timed: "Herkes üç saniye ezberler ve iki saniyede seçimini yapar.",
