...
export const DICTIONARIES = {
  en: {
    ...
    notifications: {
      ...
      title: "Notifications",
      description: "Important updates stay here, so you can always catch up even if you missed the live announcement.",
      ...
      emptyDescription: "New global announcements will appear here.",
    },
    download: {
      kicker: "Huestima mobile",
      title: "Your next color\nchallenge.",
      intro: "Download Huestima and jump into a quick color challenge whenever you feel like playing. Keep your memory sharp and see how close you can get.",
      support: "If you enjoy it, a review, a rating, or even a little comment would mean a lot and help me keep making the game better.",
      back: "Back to Huestima",
      appStore: "Download on the App Store",
      playStore: "Get it on Google Play",
      comingSoon: "Available now",
      unavailable: "Store link is not available yet.",
    },
    history: {
    ...
    home: {
      ...
      multiplayerDisabled: "Multiplayer is temporarily unavailable",
    },
    admin: {
      common: {
        ok: "OK",
      ...
      home: {
        title: "Admin Console",
        description: "Manage Huestima and monitor its system status.",
      },
      operations: {
        title: "Operations Hub",
        menuDescription: "Announcements, access controls, and game availability.",
        description: "Manage global communication and control access to live game services.",
        announcementTitle: "Global announcement",
        announcementDescription: "Deliver a message immediately and on the next first visit.",
        announcementPlaceholder: "Write an announcement",
        currentAnnouncementTitle: "Current announcement",
        emptyAnnouncementTitle: "No announcements yet",
        emptyAnnouncementDescription: "Published announcements will appear here.",
        send: "Send",
        clearAnnouncement: "Delete announcement",
        deleteAnnouncement: "Delete announcement",
        cheatTitle: "Cheat mode",
        cheatDescription: "Show the perfect-guess control in games.",
        cheatAria: "Toggle cheat mode",
        multiplayerTitle: "Multiplayer",
        multiplayerDescription: "Allow multiplayer pages, lobbies, and matches.",
        multiplayerAria: "Toggle multiplayer availability",
        maintenanceTitle: "Maintenance mode",
        maintenanceDescription: "Redirect visitors to the maintenance page.",
        maintenanceAria: "Toggle maintenance mode",
      },
      configuration: {
        title: "Game Configuration",
        menuDescription: "Choose which games and modes are available.",
        description: "Control game families and their available modes.",
        gameAria: "game availability",
        modeAria: "mode availability",
      },
      insights: {
        title: "System Insights",
        menuDescription: "Live visitors, players, lobbies, and game activity.",
        description: "Monitor Huestima’s current activity and recent multiplayer usage.",
        refreshDescription: "Refreshes automatically every five seconds.",
        live: "Live",
        ...
        completed24h: "{count} completed · 24h",
        completed: "Completed",
        averagePlayers: "{count} avg. players",
        averagePlayersShort: "Avg. players",
        uptime: "{duration} uptime",
        uptimeShort: "Uptime",
        familyBreakdown: "Game families · 24h",
        recentGames: "Recent games",
        recentGamesDescription: "Latest multiplayer sessions",
        noActivity: "No game activity yet.",
        playerUnit: "players",
      ...
      messages: {
        sessionLoadFailed: "Your admin session could not be loaded.",
        ...
        gameConfigurationUpdated: "Game configuration updated.",
      },
      confirm: {
      ...
      login: {
        title: "Admin access",
        description: "Sign in to manage Huestima’s game tools and private settings.",
        usernamePlaceholder: "Email or username",
        passwordPlaceholder: "Password",
        codePlaceholder: "Authenticator code",
        showPassword: "Show password",
        hidePassword: "Hide password",
        signIn: "Sign in",
    ...
    maintenance: {
      ...
      message: "Huestima is currently undergoing scheduled maintenance. This page will return automatically when the game is available again.",
    },
    player: {
    ...
    gameModeDescription: {
      ...
      sprint: "Complete as many levels as possible during thirty seconds of active play.",
    ...
    setup: {
      ...
      modeMechanics: {
        ...
        timed: "Time Attack gives you three seconds to memorize the target and another three seconds to lock in the guess.",
        gradient: "Gradient mode shows a two-color blend for five seconds, then asks you to match the hue at both ends.",
        sprint: "Sprint keeps new targets coming quickly and rewards the number of accurate levels you can finish under pressure.",
        visualNormal: "Classic mode opens the visual directly with its controls, so you can study and match it without a separate memory phase.",
        visualEndless: "Endless mode brings one visual after another with no final level; the run continues until you leave it.",
        visualTimed: "Time Attack opens each visual directly and gives you three seconds to lock in its color.",
        visualSprint: "Sprint sends visuals one after another and rewards the number of accurate matches you complete under pressure.",
      },
      difficultyDetail: {
      ...
      runDetail: {
        ...
        sprint: "You have 30 seconds of active adjustment time; the opening countdown, reveals, and transitions do not consume that clock.",
      },
      roundUnit: {
        single: "level",
        plural: "levels",
      ...
      singleCopy: {
        ...
        sprint: "Complete as many levels as possible during thirty seconds of active play. Ready, Set, Go and memory phases do not use your time.",
        visualNormal: "Each level starts directly with the visual and its color controls across {roundCount} levels.",
        visualEndless: "Visual rounds keep coming directly until you finish the run.",
        visualTimed: "Each visual starts directly with three seconds to lock your color across {roundCount} levels.",
        visualSprint: "Visual rounds start directly; complete as many as possible during thirty seconds of active play.",
      ...
      multiCopy: {
        ...
        sprint: "Everyone completes as many levels as possible during thirty seconds of active play.",
  ...
  tr: {
    ...
    notifications: {
      ...
      title: "Bildirimler",
      description: "Canlı duyuruyu kaçırmış olsan bile önemli güncellemeler burada kalır.",
      announcement: "Genel duyuru",
      newNotification: "Yeni bir bildirimin var",
      close: "Bildirimleri kapat",
      unread: "Okunmamış",
      unreadCount: "{count} okunmamış bildirim",
      emptyTitle: "Hepsini gördün.",
      emptyDescription: "Yeni genel duyurular burada görünür.",
    },
    download: {
      kicker: "Huestima mobil",
      title: "Sıradaki renk\nmeydan okuman.",
      intro: "Huestima'yı indir, canın ne zaman isterse kısa bir renk meydan okumasına başla. Hafızanı canlı tut ve ne kadar yaklaşabildiğini gör.",
      support: "Eğer hoşuna giderse bir yorum, puan ya da yıldız bırakman bana çok yardımcı olur; böylece oyunu geliştirmeye devam edebilirim.",
      back: "Huestima'ya dön",
      appStore: "App Store'dan indir",
      playStore: "Google Play'den edin",
      comingSoon: "Şimdi indir",
      unavailable: "Mağaza bağlantısı henüz hazır değil.",
    },
    history: {
    ...
    home: {
      ...
      singleTitle: "Singleplayer",
      multiTitle: "Multiplayer",
      multiplayerDisabled: "Multiplayer geçici olarak kullanılamıyor",
    },
    admin: {
      common: {
        ok: "Tamam",
      ...
      home: {
        title: "Admin Konsolu",
        description: "Huestima’yı yönet ve sistem durumunu buradan takip et.",
      },
      operations: {
        title: "Operasyon Merkezi",
        menuDescription: "Duyurular, erişim kontrolleri ve oyun kullanılabilirliği.",
        description: "Genel iletişimi yönet ve canlı oyun servislerine erişimi kontrol et.",
        announcementTitle: "Genel duyuru",
        announcementDescription: "Mesajı anında ve sonraki ilk ziyarette kullanıcılara ulaştır.",
        announcementPlaceholder: "Bir duyuru yaz",
        currentAnnouncementTitle: "Mevcut duyuru",
        emptyAnnouncementTitle: "Henüz duyuru yok",
        emptyAnnouncementDescription: "Yayınlanan duyurular burada görünecek.",
        send: "Gönder",
        clearAnnouncement: "Duyuruyu sil",
        deleteAnnouncement: "Duyuruyu sil",
        cheatTitle: "Hile modu",
        cheatDescription: "Oyunlarda kusursuz tahmin kontrolünü göster.",
        cheatAria: "Hile modunu değiştir",
        multiplayerTitle: "Multiplayer",
        multiplayerDescription: "Multiplayer sayfalarına, lobilere ve maçlara izin ver.",
        multiplayerAria: "Multiplayer kullanılabilirliğini değiştir",
        maintenanceTitle: "Bakım modu",
        maintenanceDescription: "Ziyaretçileri bakım sayfasına yönlendir.",
        maintenanceAria: "Bakım modunu değiştir",
      },
      configuration: {
        title: "Oyun Yapılandırması",
        menuDescription: "Oyunları ve modlarını kullanıma açıp kapat.",
        description: "Oyun ailelerini ve kullanılabilir modlarını yönet.",
        gameAria: "oyun kullanılabilirliği",
        modeAria: "mod kullanılabilirliği",
      },
      insights: {
        title: "Sistem Görünümü",
        menuDescription: "Canlı ziyaretçiler, oyuncular, lobiler ve oyun etkinliği.",
        description: "Huestima’nın anlık etkinliğini ve son multiplayer kullanımını izle.",
        refreshDescription: "Her beş saniyede otomatik olarak yenilenir.",
        live: "Canlı",
        ...
        games24h: "Oyunlar · 24s",
        gamesTotal: "Oyunlar · toplam",
        completed24h: "{count} tamamlandı · 24s",
        completed: "Tamamlanan",
        averagePlayers: "Ort. {count} oyuncu",
        averagePlayersShort: "Ort. oyuncu",
        uptime: "{duration} çalışma süresi",
        uptimeShort: "Çalışma süresi",
        familyBreakdown: "Oyun aileleri · 24s",
        recentGames: "Son oyunlar",
        recentGamesDescription: "En son multiplayer oturumları",
        noActivity: "Henüz oyun etkinliği yok.",
        playerUnit: "oyuncu",
        durationDays: "{days}g {hours}sa",
        durationHours: "{hours}sa {minutes}dk",
        durationMinutes: "{minutes}dk",
      },
      messages: {
        sessionLoadFailed: "Admin oturumu yüklenemedi.",
        logoutFailed: "Çıkış yapılamadı. Lütfen tekrar dene.",
        operationFailed: "İşlem tamamlanamadı.",
        announcementSent: "Duyuru gönderildi.",
        announcementCleared: "Duyuru temizlendi.",
        multiplayerEnabled: "Multiplayer açıldı.",
        multiplayerDisabled: "Multiplayer kapatıldı.",
        maintenanceEnabled: "Bakım modu açıldı.",
        maintenanceDisabled: "Bakım modu kapatıldı.",
        gameConfigurationUpdated: "Oyun yapılandırması güncellendi.",
      },
      confirm: {
      ...
      login: {
        title: "Admin girişi",
        description: "Huestima’nın oyun araçlarını ve özel ayarlarını yönetmek için giriş yap.",
        usernamePlaceholder: "E-posta veya kullanıcı adı",
    ...
    maintenance: {
      title: "Kısa süre içinde döneceğiz.",
      message: "Huestima şu anda planlı bakımdan geçiyor. Oyun yeniden kullanıma açıldığında bu sayfa otomatik olarak geri dönecek.",
    },
    player: {
      nameAria: "Oyuncu adı",
    ...
    gameModeDescription: {
      ...
      sprint: "Yalnızca aktif oyun sırasında işleyen 30 saniyede olabildiğince çok seviye tamamla.",
    ...
    setup: {
      ...
      modeMechanics: {
        ...
        timed: "Zamana Karşı modunda hedefi ezberlemek için üç, tahminini kilitlemek için üç saniyen vardır.",
        gradient: "Geçiş modu iki renkli bir karışımı beş saniye gösterir; ardından iki ucun tonunu ayrı ayrı eşleştirmeni ister.",
        sprint: "Depar modu yeni hedefleri hızla getirir ve baskı altında tamamladığın doğru seviye sayısını ödüllendirir.",
        visualNormal: "Klasik mod görseli doğrudan renk kontrolleriyle birlikte açar; ayrı bir ezber aşaması olmadan inceleyip eşleştirirsin.",
        visualEndless: "Sonsuz mod, son seviye olmadan görselleri art arda getirir; sen ayrılana kadar seri devam eder.",
        visualTimed: "Zamana Karşı modu her görseli doğrudan açar ve rengini kilitlemen için üç saniye verir.",
        visualSprint: "Depar modu görselleri art arda getirir ve baskı altında tamamladığın doğru eşleşme sayısını ödüllendirir.",
      },
      difficultyDetail: {
      ...
      runDetail: {
        ...
        sprint: "Yalnızca aktif ayarlama sırasında işleyen 30 saniyen vardır; başlangıç sayacı, gösterimler ve geçişler bu süreyi tüketmez.",
      },
      roundUnit: {
        single: "seviye",
        plural: "seviye",
      ...
      singleCopy: {
        ...
        sprint: "Yalnızca aktif oyun sırasında işleyen 30 saniyede olabildiğince çok seviye tamamla. Hazır, Başla ve ezber fazlarında süre durur.",
        visualNormal: "Her seviye görsel ve renk kontrolleriyle doğrudan başlar; seri {roundCount} seviye sürer.",
        visualEndless: "Görsel turlar sen bitirene kadar doğrudan gelmeye devam eder.",
        visualTimed: "Her görsel doğrudan açılır; rengini kilitlemek için üç saniyen vardır ve seri {roundCount} seviye sürer.",
        visualSprint: "Görsel turlar doğrudan başlar; yalnızca aktif oyunda işleyen 30 saniyede olabildiğince çok seviye tamamla.",
      ...
      multiCopy: {
        ...
        sprint: "Herkes yalnızca aktif oyun sırasında işleyen 30 saniyede olabildiğince çok seviye tamamlamaya çalışır.",
